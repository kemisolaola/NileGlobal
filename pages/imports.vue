                  ...
                  <v-row class="my-4" justify="center">
                    <v-col  cols="6" sm="3"> <div class="base-image-input"   :style="{ 'background-image': `url(${imageData})` }"  @click="chooseImage"
                      >
                        ...
                        <input ref="fileInput" type="file"  @input="onSelectFile" class="file-input">
                                              </div>
                        </v-col>
                      ...
                      >
                        ...
                        <input ref="fileInput1" type="file"  @input="onSelectFile1" class="file-input">
                                              </div>
                        </v-col>
                      ...
                      >
                        ...
                        <input ref="fileInput2" type="file"  @input="onSelectFile2" class="file-input">
                                              </div>
                        </v-col>
                      ...
                      >
                        ...
                        <input ref="fileInput3" type="file"  @input="onSelectFile3" class="file-input">
                                              </div>
                        </v-col>
                        </v-row>
                    </v-col>
...
.importations{
  background-image: url('../static/import.png');
